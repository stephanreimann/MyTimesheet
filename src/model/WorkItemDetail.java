...
public class WorkItemDetail {
    ...
    public WorkItemDetail(Long id) {
        this.id.set(id);
    }
    
    public WorkItemDetail(Long id, User user, Workrecord workrecord, Sprint sprint, 
            TrackingItem trackingitem, LocalTime starttime, LocalTime endtime, String description) {
        this.id.set(id);
        this.user.set(user);
    ...
    public WorkItemDetail(WorkItemDetail workitemdetail) {
        this.id.set(workitemdetail.getId());
        this.user.set(workitemdetail.getUser());
        this.workrecord.set(workitemdetail.getWorkrecord());
        this.sprint.set(workitemdetail.getSprint());
        this.trackingItem.set(workitemdetail.getTrackingItem());
        this.starttime.set(workitemdetail.getStarttime());
        this.endtime.set(workitemdetail.getEndtime());
        this.description.set(workitemdetail.getDescription());        
    }
    ...
    public boolean equals(Object obj) {
        ...
        final WorkItemDetail other = (WorkItemDetail) obj;
    ...
    public String toString() {
        ...
        sb.append(workrecord.getValue()).append(", ");
        sb.append(sprint.getValue()).append(", ");
        sb.append(trackingItem.getValue()).append(", ");
